        ...
        <div className='flex flex-col pb-3 w-full justify-center items-center'>
            <div className='py-10 w-[90%] flex flex-col gap-3'>
                ...
                <div className=' w-[65%] sm:w-[30%] md:w-[15%]'>
                    ...
                    <div onClick={() => addNew()} style={{ backgroundColor: data.color }} className='text-3xl hover:scale-110 transition-all w-[30%] rounded-2xl  justify-center p-1  flex items-center'>
